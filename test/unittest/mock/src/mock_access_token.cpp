...
{
    HapInfoParams infoParmsEnvironment = { .userID = 1,
        .bundleName = "InterfaceQueryPermission",
        .instIndex = 0,
        .dlpType = DLP_COMMON,
        .appIDDesc = "InterfaceQueryPermission",
        .isSystemApp = true };
    PermissionStateFull stateGrant = { .permissionName = TEST_PERMISSION_GRANT,
        .isGeneral = true,
        .resDeviceID = { "local" },
        .grantStatus = { PermissionState::PERMISSION_GRANTED },
        .grantFlags = { 0 } };
    HapPolicyParams policyParams = {
        .apl = APL_NORMAL, .domain = "test.domain", .permList = {}, .permStateList = { stateGrant }
    };
