 ...
 */
#ifndef APP_DOMAIN_VERIFY_CLOUD_EXT_H
#define APP_DOMAIN_VERIFY_CLOUD_EXT_H
#include <string>
#include "skill_uri.h"
...
#define APP_DOMAIN_VERIFIER_EXT_NAME ("AppDomainVerifyCloudExt")

namespace OHOS {
namespace AppDomainVerify {
class AppDomainVerifyCloudExt : public AppDomainVerifyExtBase {
public:
