...
enum AppDomainVerifySubModule {
    ...
    APP_DOMAIN_VERIFY_MODULE_CLIENT,
    APP_DOMAIN_VERIFY_CLOUD_MODULE_CLIENT,
    APP_DOMAIN_VERIFY_MODULE_SERVICE,
    APP_DOMAIN_VERIFY_CLOUD_MODULE_SERVICE,
...
enum AppDomainVerifyDomainId {
    ...
    APP_DOMAIN_VERIFY_CLIENT_DOMAIN,
    APP_DOMAIN_VERIFY_CLOUD_CLIENT_DOMAIN,
    APP_DOMAIN_VERIFY_SERVICE_DOMAIN,
    APP_DOMAIN_VERIFY_CLOUD_SERVICE_DOMAIN,
...
static constexpr OHOS::HiviewDFX::HiLogLabel APP_DOMAIN_VERIFY_MODULE_LABEL[APP_DOMAIN_VERIFY_MODULE_BUTT + 1] = {
    ...
    { LOG_CORE, APP_DOMAIN_VERIFY_CLIENT_DOMAIN, "AppDomainVerifyClient" },
    { LOG_CORE, APP_DOMAIN_VERIFY_CLOUD_CLIENT_DOMAIN, "AppDomainCloudVerifyClient" },
    { LOG_CORE, APP_DOMAIN_VERIFY_SERVICE_DOMAIN, "AppDomainVerifyService" },
    { LOG_CORE, APP_DOMAIN_VERIFY_CLOUD_SERVICE_DOMAIN, "AppDomainCloudVerifyService" },
