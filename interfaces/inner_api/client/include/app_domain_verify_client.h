...
#ifndef APP_DOMAIN_VERIFY_CLIENT_H
#define APP_DOMAIN_VERIFY_CLIENT_H
...
#include "errors.h"
#include "i_app_domain_verify_service.h"
#include "skill_uri.h"
...
class AppDomainVerifyClient : public DelayedSingleton<AppDomainVerifyClient> {
    DECLARE_DELAYED_SINGLETON(AppDomainVerifyClient);

public:
    DISALLOW_COPY_AND_MOVE(AppDomainVerifyClient);
    /**
     * VerifyDomain
...
private:
    ...
    static sptr<IAppDomainVerifyService> appDomainVerifyServiceProxy_;
    static StaticDestoryMonitor staticDestoryMonitor_;
    sptr<IRemoteObject::DeathRecipient> deathRecipient_;
};

class AppDomainVerifySaDeathRecipient : public IRemoteObject::DeathRecipient {
public:
    explicit AppDomainVerifySaDeathRecipient();
    virtual ~AppDomainVerifySaDeathRecipient();
    void OnRemoteDied(const wptr<IRemoteObject> &object) override;

private:
    DISALLOW_COPY_AND_MOVE(AppDomainVerifySaDeathRecipient);
};
}  // namespace AppDomainVerify
}  // namespace OHOS
