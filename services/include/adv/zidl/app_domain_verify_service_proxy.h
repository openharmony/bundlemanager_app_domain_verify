...
#ifndef APP_DOMAIN_VERIFY_SERVICE_PROXY_H
#define APP_DOMAIN_VERIFY_SERVICE_PROXY_H
...
class AppDomainVerifyServiceProxy : public IRemoteProxy<IAppDomainVerifyService> {
public:
    explicit AppDomainVerifyServiceProxy(const sptr<IRemoteObject> &object);
    virtual ~AppDomainVerifyServiceProxy();
...
private:
    static inline BrokerDelegator<AppDomainVerifyServiceProxy> delegator_;
};
}  // namespace AppDomainVerify
}  // namespace OHOS
