 ...
 */
#ifndef I_APP_DOMAIN_VERIFY_SERVICE_H
#define I_APP_DOMAIN_VERIFY_SERVICE_H
#include <string>
...
class IAppDomainVerifyService : public IRemoteBroker {
public:
    ...
    DECLARE_INTERFACE_DESCRIPTOR(u"ohos.appDomainVerify.IAppdomainVerifyService");
};
}  // namespace AppDomainVerify
}  // namespace OHOS
