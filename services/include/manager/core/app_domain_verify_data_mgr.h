...
class AppDomainVerifyDataMgr : public DelayedSingleton<AppDomainVerifyDataMgr> {
    DECLARE_DELAYED_SINGLETON(AppDomainVerifyDataMgr);
    DISALLOW_COPY_AND_MOVE(AppDomainVerifyDataMgr);
